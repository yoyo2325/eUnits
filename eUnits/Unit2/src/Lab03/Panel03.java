...
public class Panel03 extends JPanel {
   ...
   public Panel03() {
      ...
      for(int angle = 1; angle < 360; angle += 30) {
         int x1 = (int)((double)x + (double)size * Math.cos((double)angle * 3.141592653589793D / 180.0D));
         int y1 = (int)((double)y - (double)size * Math.sin((double)angle * 3.141592653589793D / 180.0D));
